      ...
      */}
      <style>{`
        ...
        @media print {
          ...
          .dc-print-header .ph-title { font-size: 16px; font-weight: 800; letter-spacing: 0.6px; }
          .dc-print-header .ph-meta  { text-align: right; font-size: 13px; font-weight: 700; line-height: 1.35; color: #222; }
          ...
          .dc-print-footer .pf-small { font-weight: 600; font-size: 12px; color: #222; }
        ...
        .dc-title { text-align: center; font-size: 26px; font-weight: 800; letter-spacing: 1.4px; }
        .dc-orig { text-align: right; font-size: 13px; font-weight: 700; margin: 5px 0; color: #222; letter-spacing: 0.5px; }
        ...
        .dc-meta .lbl { font-size: 12px; color: #333; letter-spacing: 0.5px; font-weight: 700; }
        .dc-meta .val { font-size: 16px; font-weight: 800; }
        .dc-secbar { background: #e8e8e8; font-weight: 800; font-size: 14px; padding: 6px 10px; border: 1px solid #000; border-top: none; letter-spacing: 0.6px; }
        .dc-deliv { border: 1px solid #000; border-top: none; padding: 8px 12px; display: flex; justify-content: space-between; align-items: flex-start; font-size: 14px; font-weight: 600; }
        .dc-deliv .for { font-weight: 800; font-size: 16px; }
        ...
        .dc-billship .tag { display: inline-block; background: #000; color: #fff; font-size: 13px; padding: 3px 13px; letter-spacing: 1.5px; margin-bottom: 6px; font-weight: 800; }
        .dc-billship .gst { font-size: 14px; font-weight: 700; margin-bottom: 4px; }
        .dc-billship .party { font-weight: 800; font-size: 16px; margin-bottom: 4px; }
        .dc-billship .addr { font-size: 14px; font-weight: 600; color: #111; }
        .dc-billship .ps { font-size: 13px; color: #222; margin-top: 6px; font-weight: 700; letter-spacing: 0.3px; }
        .dc-item { border: 1px solid #000; border-top: none; }
        .dc-item .qline { display: grid; grid-template-columns: 1fr 1fr; padding: 7px 12px; font-size: 14px; font-weight: 800; background: #fafafa; border-bottom: 0.5px solid #000; }
        .dc-item .qline .agent { text-align: right; }
        .dc-item table.bundles { width: 100%; border-collapse: collapse; font-size: 14px; }
        ...
        .dc-item table.bundles th { background: #e8e8e8; font-weight: 800; text-align: center; font-size: 14px; }
        ...
        .dc-item table.bundles tr.total td { background: #efefef; font-weight: 800; border-top: 1.4px solid #000; font-size: 14px; }
        ...
        .dc-item .summary table { width: 100%; font-size: 14px; }
        .dc-item .summary td { padding: 5px 0; }
        .dc-item .summary td.l { color: #222; font-weight: 700; }
        .dc-item .summary td.v { text-align: right; font-weight: 800; font-size: 14px; }
        .dc-vehicle { border: 1px solid #000; border-top: none; padding: 7px 12px; font-size: 14px; font-weight: 700; }
        ...
        .dc-foot > div { padding: 9px 12px; font-size: 14px; font-weight: 700; }
        .dc-foot > div + div { border-left: 0.5px solid #000; text-align: center; }
        .dc-foot .sig { font-weight: 800; margin-bottom: 36px; font-size: 14px; letter-spacing: 0.4px; }
        .dc-foot .auth { font-weight: 800; letter-spacing: 0.6px; font-size: 14px; }
        .dc-foot .seal { color: #333; font-weight: 700; letter-spacing: 0.5px; margin-top: 6px; text-align: center; font-size: 13px; }
        .dc-addrfoot { margin-top: 6px; padding-top: 6px; border-top: 1px solid #000; text-align: center; font-size: 13px; font-weight: 700; line-height: 1.55; }
        .dc-addrfoot .small { font-weight: 600; font-size: 12px; }
        .dc-watermark { position: relative; }
        .dc-status-draft::before { content: 'DRAFT'; position: absolute; inset: 0; display: flex; align-items: center; justify-content: center; font-size: 83px; color: rgba(220, 38, 38, 0.12); font-weight: 900; letter-spacing: 12px; pointer-events: none; transform: rotate(-30deg); }
        .dc-status-cancelled::before { content: 'CANCELLED'; position: absolute; inset: 0; display: flex; align-items: center; justify-content: center; font-size: 74px; color: rgba(220, 38, 38, 0.15); font-weight: 900; letter-spacing: 8px; pointer-events: none; transform: rotate(-30deg); }
      `}</style>
