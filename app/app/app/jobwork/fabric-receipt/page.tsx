...
function resolveTab(raw: string | undefined): TabConfig {
  ...
  // Default to IN-HOUSE. Cast through the TabConfig union because
  // tuple-index lookups widen to `T | undefined` under
  // `noUncheckedIndexedAccess`, even though TABS[0] is statically
  // known at compile time.
  return match ?? (TABS[0] as TabConfig);
}
