...
const GROUPS: CorrGroup[] = [
  ...
  },
  {
    ...
    cards: [
      { code: 'CORR-A1', title: 'Attendance entry screen', status: 'pending',
        evidence: 'app/attendance/page.tsx (stub only)',
        blurb: 'Day-grid entry with 5 statuses: present, absent, half-day, late, early-leave.' },
      { code: 'CORR-A2', title: 'Shift master + roster', status: 'pending',
        blurb: 'Morning (8am-8pm) / Night (8pm-8am) shift rules + employee assignment.' },
      { code: 'CORR-A3', title: 'Public holiday calendar', status: 'pending',
        blurb: 'Owner-managed holiday list with auto-mark on attendance.' },
      { code: 'CORR-A4', title: 'Wage calculation engine', status: 'pending',
        blurb: 'Per-day, per-shift, piece-rate wage compute → wages table.' },
      { code: 'CORR-A5', title: 'Attendance report (monthly)', status: 'pending',
        blurb: 'Per-employee present/absent count + wage payable.' },
      { code: 'CORR-A6', title: 'Leave tracking', status: 'pending',
        blurb: 'Casual/sick leave balance with auto-decrement.' },
      { code: 'CORR-A7', title: 'Wages payout export', status: 'pending',
        blurb: 'PDF + Excel of wages-paid per cycle for accountant.' },
    ],
  },
  {
    key: 'H',
