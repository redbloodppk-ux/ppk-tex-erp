...
export default async function EditPartyPage({
  ...
  const { data } = await (supabase as any)
    .from('party')
    .select('id, code, party_type_id, name, gstin, contact_person, phone, email, billing_address, city, state, pincode, credit_limit, payment_terms_days, is_vip, status, notes')
    .eq('id', numericId)
    .maybeSingle();
