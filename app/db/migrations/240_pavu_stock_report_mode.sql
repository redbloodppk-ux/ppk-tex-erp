-- ============================================================================
-- 240: Beam Stock Report — add production_mode output column so the report
--      can be filtered by In-house / Outsource / Jobwork.
-- ============================================================================
...
BEGIN
  FOR p IN
    ...
    -- jobwork_warp_beam entry that references this pavu.
    LEFT JOIN LATERAL (
